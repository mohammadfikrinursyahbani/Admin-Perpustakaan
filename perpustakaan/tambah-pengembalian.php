...
<div class="container mt-5">
    ...
    <form action="" method="post">
        <div class="mb-3">
            ...
            <input type="number" class="form-control" placeholder="Jumlah Buku Yang Dikembalikan" id="qty" name="qty" required>
        </div>
        <div class="mb-3">
            <label for="tanggal_pengembalian" class="form-label">Tanggal Kembali</label>
            <input type="datetime-local" class="form-control" id="tanggal_pengembalian" name="tanggal_pengembalian" placeholder="Tanggal Pengembalian" required>
        </div>
        <div class="mb-3">
...
if (isset($_POST['tambah'])) {
    mysqli_query($db, "INSERT INTO tb_pengembalian SET 
    qty = '$_POST[qty]',
